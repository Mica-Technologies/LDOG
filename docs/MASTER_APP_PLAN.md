...
>
> Build: `JAVA_HOME=/c/Users/ahawk/.jdks/azul-17.0.18 ./gradlew compileJava` (or `build` for full + tests, or `runClient` for an in-game smoke test). Currently zero compile warnings, 86 unit tests passing. Default windows shell is PowerShell — Bash tool uses bash syntax.
